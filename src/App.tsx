...
import { NodeType, Node, CharacterData, SettingData, ScriptData, ImageData, ConnectorPosition, TransformationData, VideoData } from './types/graph';
...
import { FlowCanvas } from './components/layout/FlowCanvas'; // Import separated component
...
export default function App() {
  ...
  return (
    <div 
        ...
        onMouseUp={onMouseUp}
        onMouseDown={viewportHandlers.onMouseDown}
